...
$NMois = get_month_list();
	...
	$AffichageTrack['Cercle'] = array('Message'=>"Un cercle noir d'un diamêtre d'au moins 150mm doit être dessiné au point le plus profond de la piscine",'Taille'=>1);
	$AffichageTrack['Verre'] = array('Message'=>"Le règlement \"Interdiction de contenants de vitre\" doit être écrit en un caractère d'au moins 25mm de haut - Un pictogramme est Ã©quivalent",'Taille'=>25);
	$AffichageTrack['Bousculade'] = array('Message'=>"Le règlement \"Bousculade Interdite\" doit être écrit en un caractère d'au moins 25mm de haut - Un pictogramme est Ã©quivalent",'Taille'=>25);
	...
	$ConstructionTrack['Fermeacle'] = "Il doit être possible de vérouiller les points d'accès à la piscine lorsque celle-ci est fermée";
	...
	$Date = getdate($INFO['DateI']);
	$MainOutput->AddTexte("Suite Ã© l'inspection de votre piscine (".$INFOP['Nom'].") effectuÃ©e le ".$Date['mday']." ".$NMois[$Date['mon']]." ".$Date['year']." par ".$INFOE['Prenom']." ".$INFOE['Nom'].",  nous dÃ©sirons vous informer qu'en vertu du règlement sur les bains publics LRQ S-3, r-3, vous devrez apporter certains correctifs afin d'avoir des installations conformes. Voici un descriptif des correctifs que nous vous suggÃ©rons.");
	$MainOutput->br(2);
	...
	**/
	...
	$MainOutput->br();
	$MainOutput->AddTexte("Ce rapport d'observation a Ã©tÃ© effectuÃ© Ã© la date mentionnÃ©e ci-dessus.  Tout changement survenu par la suite n'est pas mentionnÃ©.  Le personnel de Service de Sauveteurs qn inc vous tiendra informÃ© du manque de matÃ©riel, des bris ou autres anomalies en cours d'Ã©tÃ©.  Nous vous remercions de bien vouloir procÃ©der aux correctifs nÃ©cessaires afin que vous puissiez avoir des installations conformes.  Si vous avez des questions ou besoin de prÃ©cision, n'hÃ©sitez pas Ã© communiquer avec nous au (418) 687-4047.");
